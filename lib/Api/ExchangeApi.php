...
class ExchangeApi
{
     ...
     *
     * @param  \Swagger\Client\Model\V1ExchangeBody $body body (optional)
     ...
     */
    public function exchange($body = null, $paycomet_api_token = null)
    {
        list($response) = $this->exchangeWithHttpInfo($body, $paycomet_api_token);
        return $response;
    }
     ...
     * Converts a certain amount from a currency to another.
     *
     * @param  \Swagger\Client\Model\V1ExchangeBody $body (optional)
     * @param  string $paycomet_api_token PAYCOMET API key (Query privilege required) (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function exchangeWithHttpInfo($body = null, $paycomet_api_token = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2007';
        $request = $this->exchangeRequest($body, $paycomet_api_token);
     ...
     */
    public function exchangeAsync($body = null, $paycomet_api_token = null)
    {
        return $this->exchangeAsyncWithHttpInfo($body, $paycomet_api_token)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function exchangeAsyncWithHttpInfo($body = null, $paycomet_api_token = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2007';
        $request = $this->exchangeRequest($body, $paycomet_api_token);
     ...
     */
    protected function exchangeRequest($body = null, $paycomet_api_token = null)
    {

        $resourcePath = '/v1/exchange';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
