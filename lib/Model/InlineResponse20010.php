...
class InlineResponse20010 implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['iso_num'] = isset($data['iso_num']) ? $data['iso_num'] : null;
    ...
    {
        return $this->container['iso_num'];
    }

    /**
     * Sets iso_num
     *
     * @param int $iso_num iso_num
     *
     * @return $this
     */
    public function setIsoNum($iso_num)
    {
        $this->container['iso_num'] = $iso_num;
