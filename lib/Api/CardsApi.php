...
class CardsApi
{
     ...
     *
     * @param  \Swagger\Client\Model\V1CardsBody $body body (optional)
     ...
     * Tokenizes a card. Either card number and CVC2 or jetToken are required. For you to send directly the card data you should be PCI certified or the accepting the requirement to submit quarterly SAQ-AEP and get ASV scans. For most users is strongly recommended getting the jetToken with JETIFRAME or using GET integration to register the cards instead of REST.
     *
     * @param  \Swagger\Client\Model\V1CardsBody $body (optional)
     * @param  string $paycomet_api_token PAYCOMET API key (Token actions privilege required) (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \Swagger\Client\Model\CardsEditBody $body body (optional)
     * @param  string $paycomet_api_token PAYCOMET API key (Token actions privilege required) (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Changes the expiry date, cvc2 or both
     *
     * @param  \Swagger\Client\Model\CardsEditBody $body (optional)
     * @param  string $paycomet_api_token PAYCOMET API key (Token actions privilege required) (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Get card info
     *
     * @param  \Swagger\Client\Model\CardsInfoBody $body body (optional)
     ...
     * Get card info
     *
     * @param  \Swagger\Client\Model\CardsInfoBody $body (optional)
     * @param  string $paycomet_api_token PAYCOMET API key (Query privilege required) (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \Swagger\Client\Model\CardsPhysicalBody $body body (optional)
     * @param  string $paycomet_api_token PAYCOMET API key (Token actions privilege required) (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Tokenize a card by physical encrypted data
     *
     * @param  \Swagger\Client\Model\CardsPhysicalBody $body (optional)
     * @param  string $paycomet_api_token PAYCOMET API key (Token actions privilege required) (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    /**
     * Operation physicalEditCard
     *
     * Edit a card entered by physical encrypted data
     *
     * @param  \Swagger\Client\Model\PhysicalEditBody $body body (optional)
     * @param  string $paycomet_api_token PAYCOMET API key (Token actions privilege required) (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function physicalEditCard($body = null, $paycomet_api_token = null)
    {
        list($response) = $this->physicalEditCardWithHttpInfo($body, $paycomet_api_token);
        return $response;
    }

    /**
     * Operation physicalEditCardWithHttpInfo
     *
     * Edit a card entered by physical encrypted data
     *
     * @param  \Swagger\Client\Model\PhysicalEditBody $body (optional)
     * @param  string $paycomet_api_token PAYCOMET API key (Token actions privilege required) (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function physicalEditCardWithHttpInfo($body = null, $paycomet_api_token = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2005';
        $request = $this->physicalEditCardRequest($body, $paycomet_api_token);
    ...
    /**
     * Operation physicalEditCardAsync
     *
     * Edit a card entered by physical encrypted data
     *
     * @param  \Swagger\Client\Model\PhysicalEditBody $body (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function physicalEditCardAsync($body = null, $paycomet_api_token = null)
    {
        return $this->physicalEditCardAsyncWithHttpInfo($body, $paycomet_api_token)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation physicalEditCardAsyncWithHttpInfo
     *
     * Edit a card entered by physical encrypted data
     *
     * @param  \Swagger\Client\Model\PhysicalEditBody $body (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function physicalEditCardAsyncWithHttpInfo($body = null, $paycomet_api_token = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2005';
        $request = $this->physicalEditCardRequest($body, $paycomet_api_token);
    ...
    /**
     * Create request for operation 'physicalEditCard'
     *
     * @param  \Swagger\Client\Model\PhysicalEditBody $body (optional)
     * @param  string $paycomet_api_token PAYCOMET API key (Token actions privilege required) (optional)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function physicalEditCardRequest($body = null, $paycomet_api_token = null)
    {

        $resourcePath = '/v1/cards/physical/edit';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * Removes a card
     *
     * @param  \Swagger\Client\Model\CardsDeleteBody $body body (optional)
     * @param  string $paycomet_api_token PAYCOMET API key (Token actions privilege required) (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Removes a card
     *
     * @param  \Swagger\Client\Model\CardsDeleteBody $body (optional)
     * @param  string $paycomet_api_token PAYCOMET API key (Token actions privilege required) (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
