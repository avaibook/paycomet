...
/**
 * V1paymentsdccPayment Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1paymentsdccPayment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1paymentsdcc_payment';
     ...
     * Sets order
     *
     * @param string $order Reference of the operation. Must be unique on every valid transaction.
     *
     * @return $this
     */
