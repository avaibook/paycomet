...
/**
 * V1formPaymentMerchantDataShipping Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1formPaymentMerchantDataShipping implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1form_payment_merchantData_shipping';
     ...
     *
     * @param string $ship_addr_country Numerical code (ISO 3166-1) of the country of the delivery address
     *
     * @return $this
     */
     ...
     *
     * @param string $ship_addr_state State or province of the delivery address. Must comply with ISO 3166-2.
     *
     * @return $this
     */
