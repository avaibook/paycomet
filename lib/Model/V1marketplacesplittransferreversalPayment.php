...
/**
 * V1marketplacesplittransferreversalPayment Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1marketplacesplittransferreversalPayment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1marketplacesplittransferreversal_payment';
     ...
     * Sets auth_code
     *
     * @param string $auth_code Authorization bank code of the transaction (required to execute a split)
     *
     * @return $this
     */
