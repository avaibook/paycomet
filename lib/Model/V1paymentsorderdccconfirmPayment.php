...
/**
 * V1paymentsorderdccconfirmPayment Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1paymentsorderdccconfirmPayment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1paymentsorderdccconfirm_payment';
     ...
     * Sets id_user
     *
     * @param string $id_user Identification of user card given by PAYCOMET. Mandatory if is a card payment.
     *
     * @return $this
     */
